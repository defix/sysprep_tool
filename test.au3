...
;                  失败  - 返回0
; Author ........: thesnoW([email]rundll32@126.com[/email])
; Modified.......:
; Remarks .......:
; Related .......:
; Link ..........;
...
; Author ........: Sxd
; Modified.......:
; Remarks .......: 此函数是采用[url]http://www.aamailsoft.com/getip.php[/url]的数据,不保证长期有效.
; Related .......:
; Link ..........;
; Example .......; Yes
; ===============================================================================================================================
...
; Remarks .......:
; Related .......:
; Link ..........; [url]http://msdn.microsoft.com/en-us/library/bb776460[/url](VS.85).aspx
; Example .......; Yes
; ===============================================================================================================================
Func _InetIsOffline()
	Return DllCall("url.dll", "bool", "InetIsOffline", "DWORD", 0)
EndFunc   ;==>_InetIsOffline
...
; 作者:            thesnow([email]rundll32@126.com[/email])
;
;======================================================
