...
Func SJYHXX()
	...
	$hForm1 = GUICreate("收集用户信息", 346, 451, 731, 336, BitOR($GUI_SS_DEFAULT_GUI, $WS_MAXIMIZEBOX, $WS_TABSTOP))
	...
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	$idMobile = GUICtrlCreateEdit("", 112, 312, 209, 27, BitOR($ES_WANTRETURN, $ES_NUMBER))
	GUICtrlSetFont(-1, 12, 400, 0, "Consolas")
	$idTelephone = GUICtrlCreateEdit("", 161, 360, 161, 27, BitOR($ES_WANTRETURN, $ES_NUMBER))
	GUICtrlSetFont(-1, 12, 400, 0, "Consolas")
	$idNext = GUICtrlCreateButton("下一步", 248, 408, 75, 33)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	...
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlCreateLabel("手　　机：", 24, 312, 84, 24, $WS_TABSTOP)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlCreateLabel("固定电话：", 24, 360, 84, 24, $WS_TABSTOP)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlCreateLabel("0951-", 112, 363, 49, 23, $WS_TABSTOP)
	GUICtrlSetFont(-1, 12, 400, 0, "Consolas")
...
Func _UpdateOutput()
	...
	$hostname = StringUpper(StringReverse(StringTrimRight(StringSplit(StringReverse(_StringToLetter($department)), ",")[4], 3))) & "-" & StringReplace(StringRight($aNicconfig[1][5], 8), ":", "")
